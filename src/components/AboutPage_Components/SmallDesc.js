    ...
    <section className={classes.smallDesc}>
      <div className={classes.smallDescContainer}>
        <div className={classes.smallDescContainers}>
          ...
          <div>
            <p>
              Crafting company brand identities that communicate and connect
        ...
        <div className={classes.smallDescContainers}>
          ...
          <div>
            <p>
              Creating websites that are free of any barriers that will prevent
              users access or interaction to any website.
            </p>
          </div>
        </div>
        <div className={classes.smallDescContainers}>
          ...
          <div>
            <p>
              Taking measures to achieve a higher level of effectiveness and
